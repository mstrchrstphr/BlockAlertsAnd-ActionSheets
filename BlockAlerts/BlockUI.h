...
#define kAlertViewTitleFont             [UIFont fontWithName:@"Avenir" size:18]
...
#define kAlertViewMessageFont           [UIFont fontWithName:@"Avenir" size:16]
...
#define kAlertViewButtonFont            [UIFont fontWithName:@"Avenir Heavy" size:16]
